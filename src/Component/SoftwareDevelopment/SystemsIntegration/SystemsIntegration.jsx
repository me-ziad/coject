...
export default function SystemsIntegration() {
  ...
  return (
    <>
      <Header
        title={t("Systemsconsolidationservices")}
        role={t("service")}
        description={t("Systemsconsolidationservices")}
      />

      <TitleSection
        title1={t("integration")}
        title2={t("Systems")}
        discription={t("Connectyour")}
      />
        ...
        <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center justify-between gap-10 px-4 sm:px-8 lg:px-16">
          ...
          <motion.div {...fadeInLeft} className="w-full lg:w-1/2 px-5">
            ...
            <ul className="text-sm sm:text-base font-light space-y-1 list-disc pr-5">
              <li>{t("Databasei")}</li>
              <li>{t("IntegratiooERPCRMHRandotherapplications")}</li>
