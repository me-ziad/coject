...
export default function DataAnalytics() {
  ...
  return (
    <>
      <Header
        title={t("Analyticsanddataservices")}
        role={t("service")}
        description={t("Analyticsanddataservices")}
      />

      <TitleSection
        title1={t("development")}
        title2={t("Software")}
        discription={t("Weprovideintegrated")}
      />
