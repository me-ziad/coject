...
// === Animation config fixed for all elements ===
  const fadeUp = {
  ...
  return (
    <>
      ...
      <TitleSection
        title1={t("Cyber")}
        title2={t("security")}
        discription={t("WebuProtectyourdataldandmanage")}
      />
        ...
        <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center justify-between gap-10 px-4 sm:px-8 lg:px-16">
          ...
          <motion.div {...fadeLeft} className="w-full lg:w-1/2 px-5">
            ...
            <ul className="text-sm sm:text-base font-light space-y-1 list-disc pr-5">
              <li>{t("Penetrationtestingtodetectvulnerabilities")}</li>
              <li>{t("IdentitAccessManagement")}</li>
              <li>{t("Integratedmonitoringsystemstodetectthreats")}</li>
              <li>{t("Protectionfrommalwareandcyberattacks")}</li>
              <li>
                {t(
                  "Securityconsultingtoensurecompliancewithlocalandinternationalstandards"
                )}
              </li>
            </ul>
          </motion.div>
