...
export default function SoftwareDevelopment() {
  ...
  return (
    <>
      <TitleSection
        title1={t("discription")}
        title2={t("Development")}
        discription={t("provideintegrated")}
      />
        ...
        <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center justify-between gap-10 px-4 sm:px-8 lg:px-16">
          ...
          <motion.div {...fadeInLeft} className="w-full lg:w-1/2 px-5">
            ...
            <p className="leading-relaxed mb-4 text-sm sm:text-base md:text-md font-light">
              {t("Withourextensiveoftwareexperience")}
            </p>

            <p className="leading-relaxed mb-6 text-sm sm:text-base md:text-md font-light">
              {t("Fromsimpleapplications")}
            </p>
            ...
            <ul className="text-sm sm:text-base font-light space-y-1 list-disc pr-5">
              <li>{t("Webapplicationdesignanddevelopment")}</li>
              <li>{t("Mobileapplicationdesign")}</li>
              <li>{t("DevelopmentofERPandCRsystems")}</li>
              <li>{t("Developcustomizedsolutionsondemand")}</li>
              <li>{t("SystemsIntegration")}</li>
            </ul>
          </motion.div>
      ...
      <section className="py-16 bg-[#f5f7fa] text-[#808080] md:px-10 lg:px-30">
        <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between gap-20 px-4 sm:px-8 lg:px-16">
          ...
          {/* Left Text Section */}
          <motion.div {...fadeInRight} className="w-full lg:w-1/2 px-5">
            ...
            <ul className="text-sm sm:text-base font-light space-y-1 list-disc pr-5">
              <li>{t("Solutionstailoredtosuitthenatureofyourbusiness")}</li>
              <li>{t("Accelerateprocessesandreduceoperationalcosts")}</li>
              <li>{t("Improvingproductivitythroughsmartsystems")}</li>
              <li>{t("Improvecustomerandenduserexperience")}</li>
              <li>{t("Flexibilitytoexpandtokeeppacewithyourcompanygrowth")}</li>
            </ul>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white text-[#4f4f4f] md:px-10 lg:px-30">
        <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between gap-10 px-4 sm:px-8 lg:px-16">
          {/* Right Text Section */}
          <motion.div {...fadeInUp} className="w-full lg:w-1/2 px-5">
            ...
            <p className="leading-relaxed text-sm sm:text-base font-light md:text-md text-gray-600">
              {t("Thisserviceisspecificallyintendedfor")}
              <span className="font-semibold text-[#808080] mx-1">
