...
export default function TechnicalConsulting() {
  ...
  return (
    <>
      <Header
        title={t("Technicalconsultingservices")}
        role={t("service")}
        description={t("Technicalconsultingservices")}
      />

      <TitleSection
        title1={t("Consulting")}
        title2={t("Technology")}
        discription={t("Weoffer")}
      />
        ...
        <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center justify-between gap-10 px-4 sm:px-8 lg:px-16">
          ...
          <motion.div {...fadeInLeft} className="w-full lg:w-1/2 px-5">
            ...
            <ul className="text-sm sm:text-base font-light space-y-1 list-disc pr-5">
              <li>{t("Acomprehensive")}</li>
              <li>{t("BackDevelopingdigitalup")}</li>
              <li>{t("Infrastructureand")}</li>
              <li>{t("Systemsandapplications")}</li>
              <li>{t("Roadmapforfuture")}</li>
            </ul>
          </motion.div>
      ...
      <section className="py-16 bg-[#f5f7fa] text-[#808080] md:px-10 lg:px-30">
        <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between gap-20 px-4 sm:px-8 lg:px-16">
          ...
          <motion.div {...fadeInRight} className="w-full lg:w-1/2 px-5">
            ...
            <ul className="text-sm sm:text-base font-light space-y-1 list-disc pr-5">
              <li>{t("Thoughtful")}</li>
              <li>{t("Reducelongterm")}</li>
              <li>{t("Complieswith")}</li>
              <li>{t("Customizedsupport")}</li>
              <li>{t("Reducingthe")}</li>
            </ul>
          </motion.div>
        </div>
